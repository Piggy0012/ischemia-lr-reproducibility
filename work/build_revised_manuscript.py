...
ROOT=Path(__file__).resolve().parent;OUT=ROOT.parent/'outputs/revised';OUT.mkdir(parents=True,exist_ok=True)
raw=(ROOT/'manuscript_revised_source.md').read_text(encoding='utf-8')
