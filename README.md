...
The analysis is permanently archived as [version DOI 10.5281/zenodo.22705840](https://doi.org/10.5281/zenodo.22705840), corresponding to [release v3.0.0](https://github.com/Piggy0012/ischemia-lr-reproducibility/releases/tag/v3.0.0) and fixed analysis commit `00067af9ab495f79385403141e06471b079afed6`. All 2,487 archived Git files were downloaded and verified against that commit, including 2,485 indexed payload hashes. The [reviewed revision-3 manuscripts](outputs/reproducibility_v3/README.md) include English and Chinese main/supplement DOCX and PDF files with this DOI; they are versioned separately from the analysis. No preprint or journal submission has occurred. See the [archive verification](outputs/reproducibility_v3/zenodo_archive_verification.json), [publication status](outputs/reproducibility_v3/publication_status.json), and [verified upstream feedback](https://github.com/scverse/liana/pull/261#issuecomment-5632198130).

The Zenodo record contains the fixed repository ZIP, including code, environment locks, cell summaries, complete results and figure source data. The Windows R binary overlay and pinned third-party CellChat source tarball are separately available as GitHub release assets; those two files are not included in this Zenodo record.
